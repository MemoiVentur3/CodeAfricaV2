...
const Pioneer = () => {
  ...
  return (
    <>
      {isMobile === true ? 
      (
        <div className="my-[20px] mb-[30px] px-[20px]">
        ...
        <div className='justify-center'>
          ...
          <div className="items-center align-center text-[#fff] justify-center flex flex-col gap-5 bg-Pioneer bg-no-repeat">
            ...
            <div className="text-center">
              ...
              <span className="font-[700] text-[28px] md:text-[48px] lg:text-[64px] text-white"><b className="font-[700] text-[28px] md:text-[48px] lg:text-[64px] text-[#04BCD4]">Developers</b> Together</span>
            </div>
            ...
            <button className="px-8 py-4 bg-[#04BCD4] rounded-[10px]">Join our community</button>
            </a>
          </div>
        </div>
      </div>
      ...
      (
          ...
          <div className="items-center justify-center flex flex-col gap-5 bg-Pioneer px-10 py-10 bg-no-repeat text-[#fff]">
            ...
            <div className="text-center">
              ...
              <span className="font-[700] text-[64px] text-white"><b className="text-[#04BCD4]">Developers</b> Together</span>
            </div>
